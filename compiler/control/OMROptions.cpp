...
TR::OptionTable OMR::Options::_jitOptions[] = {
   ...
   {"disableForceHelperTransform" ,       "O\tdisable value types helper transforms",          TR::Options::disableOptimization, forceHelperTransform, 0, "P"},
   ...
   {"traceForceHelperTransform",        "L\ttrace force helper transform",                 TR::Options::traceOptimization, forceHelperTransform, 0, "P"},
