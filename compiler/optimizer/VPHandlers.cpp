...
traceMsg(vp->comp(), "   lhs asShortConstraint() %p asShortConst() %p asShortRange() %p asIntConstraint() %p asIntConst() %p asIntRange() %p asLongConstraint() %p asLongConst() %p asLongRange() %p asBCDValue() %p asBCDSign() %p asClass() %p asClassType() %p asResolvedClass() %p asFixedClass() %p asConstString() %p asKnownObject() %p asUnresolvedClass() %p asClassPresence() %p asNullObject() %p asNonNullObject() %p asPreexistentObject() %p asArrayInfo() %p asObjectLocation() %p asMergedConstraints() %p asMergedShortConstraints() %p asMergedIntConstraints() %p asMergedLongConstraints() %p asUnreachablePath() %p asVPSync() %p asRelation() %p asLessThanOrEqual() %p asGreaterThanOrEqual() %p asEqual() %p asNotEqual() %p asShortConstraint() %p asShortConst() %p asShortRange() %p asIntConstraint() %p asIntConst() %p asIntRange() %p asLongConstraint() %p asLongConst() %p asLongRange() %p asClass() %p asClassType() %p asResolvedClass() %p asFixedClass() %p asConstString() %p asKnownObject() %p asUnresolvedClass() %p asClassPresence() %p asNullObject() %p asNonNullObject() %p asPreexistentObject() %p asArrayInfo() %p asObjectLocation() %p asMergedConstraints() %p asMergedShortConstraints() %p asMergedIntConstraints() %p asMergedLongConstraints() %p asUnreachablePath() %p asVPSync() %p asRelation() %p asLessThanOrEqual() %p asGreaterThanOrEqual() %p asEqual() %p asNotEqual() %p\n", lhs->asShortConstraint(), lhs->asShortConst(), lhs->asShortRange(), lhs->asIntConstraint(), lhs->asIntConst(), lhs->asIntRange(), lhs->asLongConstraint(), lhs->asLongConst(), lhs->asLongRange(), lhs->asBCDValue(), lhs->asBCDSign(), lhs->asClass(), lhs->asClassType(), lhs->asResolvedClass(), lhs->asFixedClass(), lhs->asConstString(), lhs->asKnownObject(), lhs->asUnresolvedClass(), lhs->asClassPresence(), lhs->asNullObject(), lhs->asNonNullObject(), lhs->asPreexistentObject(), lhs->asArrayInfo(), lhs->asObjectLocation(), lhs->asMergedConstraints(), lhs->asMergedShortConstraints(), lhs->asMergedIntConstraints(), lhs->asMergedLongConstraints(), lhs->asUnreachablePath(), lhs->asVPSync(), lhs->asRelation(), lhs->asLessThanOrEqual(), lhs->asGreaterThanOrEqual(), lhs->asEqual(), lhs->asNotEqual(), lhs->asShortConstraint(), lhs->asShortConst(), lhs->asShortRange(), lhs->asIntConstraint(), lhs->asIntConst(), lhs->asIntRange(), lhs->asLongConstraint(), lhs->asLongConst(), lhs->asLongRange(), lhs->asClass(), lhs->asClassType(), lhs->asResolvedClass(), lhs->asFixedClass(), lhs->asConstString(), lhs->asKnownObject(), lhs->asUnresolvedClass(), lhs->asClassPresence(), lhs->asNullObject(), lhs->asNonNullObject(), lhs->asPreexistentObject(), lhs->asArrayInfo(), lhs->asObjectLocation(), lhs->asMergedConstraints(), lhs->asMergedShortConstraints(), lhs->asMergedIntConstraints(), lhs->asMergedLongConstraints(), lhs->asUnreachablePath(), lhs->asVPSync(), lhs->asRelation(), lhs->asLessThanOrEqual(), lhs->asGreaterThanOrEqual(), lhs->asEqual(), lhs->asNotEqual());
traceMsg(vp->comp(), "   rhs asShortConstraint() %p asShortConst() %p asShortRange() %p asIntConstraint() %p asIntConst() %p asIntRange() %p asLongConstraint() %p asLongConst() %p asLongRange() %p asBCDValue() %p asBCDSign() %p asClass() %p asClassType() %p asResolvedClass() %p asFixedClass() %p asConstString() %p asKnownObject() %p asUnresolvedClass() %p asClassPresence() %p asNullObject() %p asNonNullObject() %p asPreexistentObject() %p asArrayInfo() %p asObjectLocation() %p asMergedConstraints() %p asMergedShortConstraints() %p asMergedIntConstraints() %p asMergedLongConstraints() %p asUnreachablePath() %p asVPSync() %p asRelation() %p asLessThanOrEqual() %p asGreaterThanOrEqual() %p asEqual() %p asNotEqual() %p asShortConstraint() %p asShortConst() %p asShortRange() %p asIntConstraint() %p asIntConst() %p asIntRange() %p asLongConstraint() %p asLongConst() %p asLongRange() %p asClass() %p asClassType() %p asResolvedClass() %p asFixedClass() %p asConstString() %p asKnownObject() %p asUnresolvedClass() %p asClassPresence() %p asNullObject() %p asNonNullObject() %p asPreexistentObject() %p asArrayInfo() %p asObjectLocation() %p asMergedConstraints() %p asMergedShortConstraints() %p asMergedIntConstraints() %p asMergedLongConstraints() %p asUnreachablePath() %p asVPSync() %p asRelation() %p asLessThanOrEqual() %p asGreaterThanOrEqual() %p asEqual() %p asNotEqual() %p\n", rhs->asShortConstraint(), rhs->asShortConst(), rhs->asShortRange(), rhs->asIntConstraint(), rhs->asIntConst(), rhs->asIntRange(), rhs->asLongConstraint(), rhs->asLongConst(), rhs->asLongRange(), rhs->asBCDValue(), rhs->asBCDSign(), rhs->asClass(), rhs->asClassType(), rhs->asResolvedClass(), rhs->asFixedClass(), rhs->asConstString(), rhs->asKnownObject(), rhs->asUnresolvedClass(), rhs->asClassPresence(), rhs->asNullObject(), rhs->asNonNullObject(), rhs->asPreexistentObject(), rhs->asArrayInfo(), rhs->asObjectLocation(), rhs->asMergedConstraints(), rhs->asMergedShortConstraints(), rhs->asMergedIntConstraints(), rhs->asMergedLongConstraints(), rhs->asUnreachablePath(), rhs->asVPSync(), rhs->asRelation(), rhs->asLessThanOrEqual(), rhs->asGreaterThanOrEqual(), rhs->asEqual(), rhs->asNotEqual(), rhs->asShortConstraint(), rhs->asShortConst(), rhs->asShortRange(), rhs->asIntConstraint(), rhs->asIntConst(), rhs->asIntRange(), rhs->asLongConstraint(), rhs->asLongConst(), rhs->asLongRange(), rhs->asClass(), rhs->asClassType(), rhs->asResolvedClass(), rhs->asFixedClass(), rhs->asConstString(), rhs->asKnownObject(), rhs->asUnresolvedClass(), rhs->asClassPresence(), rhs->asNullObject(), rhs->asNonNullObject(), rhs->asPreexistentObject(), rhs->asArrayInfo(), rhs->asObjectLocation(), rhs->asMergedConstraints(), rhs->asMergedShortConstraints(), rhs->asMergedIntConstraints(), rhs->asMergedLongConstraints(), rhs->asUnreachablePath(), rhs->asVPSync(), rhs->asRelation(), rhs->asLessThanOrEqual(), rhs->asGreaterThanOrEqual(), rhs->asEqual(), rhs->asNotEqual());
}
            if (branchOnEqual)
               cannotBranch = true;
            else
