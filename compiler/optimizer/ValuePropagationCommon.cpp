...
if (trace())
{
traceMsg(comp(), "In OMR::ValuePropagation::launchNode %p n%un - _useDefInfo [%p]; _useDefInfo->_defsChecklist [%p] = ", node, node->getGlobalIndex(), _useDefInfo, _useDefInfo->_defsChecklist);
...
if (trace())
{
traceMsg(comp(), "Leaving OMR::ValuePropagation::launchNode %p n%un - _useDefInfo [%p]; _useDefInfo->_defsChecklist [%p] = ", node, node->getGlobalIndex(), _useDefInfo, _useDefInfo->_defsChecklist);
_useDefInfo->_defsChecklist->debugMe(comp());
traceMsg(comp(), "\n");
}
      }
